...
import 'package:word_wise/app/components/input_form_widget.dart';
import 'package:word_wise/app/components/link_button_widget.dart';
import 'package:word_wise/app/components/primary_button_widget.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: GestureDetector(child: const Icon(Icons.chevron_left, size: 35), onTap: () => context.go('/${WordsPage.path}')),
        ),
        leadingWidth: 40,
